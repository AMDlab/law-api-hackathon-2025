    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* モーダル本体 */}
          <div className="relative bg-popover text-popover-foreground rounded-lg shadow-xl max-w-2xl max-h-[80vh] overflow-y-auto m-4">
            {/* ヘッダー */}
            <div className="sticky top-0 bg-popover border-b px-6 py-4 flex items-center justify-between">
            ...
            <div className="px-6 py-4 space-y-6">
              ...
              <section>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-24 h-10 border-2 border-border bg-card rounded flex items-center justify-center text-xs flex-shrink-0">
                      情報
                    </div>
                  ...
                  {/* 処理ノード */}
                  <div className="flex items-start gap-3">
                    <div className="w-24 h-10 border-2 border-border bg-card rounded-xl flex items-center justify-center text-xs flex-shrink-0">
                      処理
                    </div>
                    <div className="text-sm">
                ...
                <div className="space-y-2 text-sm">
                  <div className="grid grid-cols-1 gap-2">
                    <div className="flex items-start gap-2 bg-muted p-2 rounded">
                      <span className="font-mono text-xs bg-blue-500/20 text-blue-400 px-1.5 py-0.5 rounded flex-shrink-0">
                        命題真偽
                      </span>
                    ...
                    <div className="flex items-start gap-2 bg-muted p-2 rounded">
                      <span className="font-mono text-xs bg-purple-500/20 text-purple-400 px-1.5 py-0.5 rounded flex-shrink-0">
                        区分情報
                      </span>
                      <span className="text-muted-foreground">
                    ...
                    <div className="flex items-start gap-2 bg-muted p-2 rounded">
                      <span className="font-mono text-xs bg-green-500/20 text-green-400 px-1.5 py-0.5 rounded flex-shrink-0">
                        数値
                      </span>
                      <span className="text-muted-foreground">
                        整数値または実数値（例: 延べ面積、高さ）
                    ...
                    <div className="flex items-start gap-2 bg-muted p-2 rounded">
                      <span className="font-mono text-xs bg-cyan-500/20 text-cyan-400 px-1.5 py-0.5 rounded flex-shrink-0">
                        幾何学概念
                      </span>
                      <span className="text-muted-foreground">
                        点/方向/線形状/面形状/ソリッド（例:
                    ...
                    <div className="flex items-start gap-2 bg-muted p-2 rounded">
                      <span className="font-mono text-xs bg-yellow-500/20 text-yellow-400 px-1.5 py-0.5 rounded flex-shrink-0">
                        集合定義
                      </span>
                      <span className="text-muted-foreground">
                    ...
                    <div className="flex items-start gap-2 bg-orange-500/10 p-2 rounded border border-orange-500/30">
                      <span className="font-mono text-xs bg-orange-500/20 text-orange-400 px-1.5 py-0.5 rounded flex-shrink-0">
                        視認情報
                      </span>
                      <span className="text-muted-foreground">
                        人による総合的認識・判断が必要（例:
              ...
              <section>
                ...
                <div className="grid grid-cols-1 gap-2">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 border-2 border-cyan-400 bg-cyan-500/20 rounded-lg flex-shrink-0"></div>
                    <div className="text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 border-2 border-orange-300 bg-orange-500/20 rounded-lg flex-shrink-0"></div>
                    <div className="text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 border-2 border-green-400 bg-green-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 border-2 border-muted-foreground bg-muted rounded-lg flex items-center justify-center flex-shrink-0">
                      <span className="text-[8px]">+</span>
                    </div>
                    <div className="text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 border-2 border-amber-400 bg-amber-500/20 rounded-lg border-l-0 flex-shrink-0"></div>
                    <div className="text-sm">
              ...
              <section>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 border-2 border-border bg-card rounded"></div>
                    <span className="text-sm">通常の情報</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 border-2 border-orange-300 bg-orange-500/20 rounded"></div>
              ...
              <section>
                ...
                <div className="flex items-center gap-4">
                  <div className="relative w-10 h-8 border-2 border-border rounded">
                    <div className="absolute -top-1 -right-1 w-full h-full border-2 border-border rounded bg-card"></div>
                  </div>
              ...
              <section>
                ...
                <div className="bg-muted p-3 rounded text-sm">
                  ...
                  <div className="text-muted-foreground text-xs space-y-1">
                    <div>
                      <span className="font-medium text-foreground">主体:</span>{" "}
                      建築物（数えることができるもの）
                    </div>
                    <div>
                      <span className="font-medium text-foreground">性質:</span>{" "}
                      高さ（主体の属性）
                    </div>
                    <div>
              ...
              <section>
                ...
                <div className="flex items-center gap-2 mb-2">
                  <div className="px-2 py-1 border-2 border-border bg-card rounded text-xs">
                    <span className="text-blue-400 mr-1">[A]</span>敷地面積
                  </div>
                  <span className="text-sm text-muted-foreground">
                    ← 記号Aが付与された情報
                  </span>
              ...
              <section>
                ...
                <div className="border border-border rounded-lg overflow-hidden">
                  ...
                  <div className="p-3 space-y-2 text-xs">
                    ...
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">性質</span>
                      <span>高さ</span>
                    </div>
                    <div className="flex justify-between">
              ...
              <section>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-6 border-2 border-blue-400 bg-blue-500/20 rounded-full flex items-center justify-center text-[8px]">
                      開始
                    </div>
                    <span className="text-sm text-muted-foreground">
                      開始/終了ノード
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 border-2 border-yellow-400 bg-yellow-500/20 rotate-45 flex items-center justify-center">
